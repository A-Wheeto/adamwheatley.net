...
export const careerGrades: Grade[] = [
  {
    ...
    skills: ['Bouldering Enthusiast', 'Guitarist', 'Drummer', 'Problem Solver', 'Creative Thinker', 'Detail Oriented']
  },
  {
    grade: 'V1',
    ...
    holdColor: 'bg-slate-500',
    year: 'Nov 2018 - Nov 2019',
    skills: ['High Volume Support', 'Windows 7/10', 'Citrix & RDP', 'Active Directory', 'Mobile Support', 'Ticket Management']
  },
  {
    grade: 'V2',
    ...
    holdColor: 'bg-zinc-500',
    year: 'Nov 2019 - Aug 2022',
    skills: ['2000+ Users', 'Multi-Platform', 'Mac OS', 'Chromebooks', 'User Training', 'Multi-Site Support']
  },
  {
    grade: 'V3',
    ...
    color: 'from-stone-500 to-emerald-600',
    holdColor: 'bg-emerald-600',
    year: 'Aug 2022 - Sep 2023',
    skills: ['SharePoint Design', 'MS Data Sync', 'MIS Integration', 'Client Onboarding', 'Permissions Mgmt', 'Consultations']
  },
  {
    grade: 'V4',
    ...
    holdColor: 'bg-teal-500',
    year: 'Sep 2023 - Mar 2024',
    skills: ['Azure AD', 'MS Dynamics', 'SharePoint Migration', 'Infrastructure', 'Linux', 'Intune']
  },
  {
    grade: 'V5',
    ...
    skills: ['Ruby on Rails', 'JavaScript/Stimulus', 'RSpec', 'Heroku', 'API Integration', 'MS Dynamics']
  },
  {
    grade: 'V6',
    ...
    skills: ['Next.js', 'TypeScript', 'Full Stack', 'Cloud Deploy', 'CI/CD', 'Vercel']
  }
]